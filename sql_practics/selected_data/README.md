...
* <a href="">Переоценка книг в конце месяца</a>
* <a href="">Уценка книг цена которых больше 400руб</a>
* <a href="">Расчитать размер скидки в зависимости от количества и цены</a>
* <a href="">Выдать подарок в зависимсти от цены купленной книги</a>
* <a href="">Определить категории цен "Высокая","Низкая","Средняя" </a>
* <a href="">Вывести округленную цену товара в рублях и копейках при количестве товара больше 11 шт</a>
* <a href="">Сортировка по длине названия книги и по автору</a>
* <a href="">Подготовить информацию для распродажи по определенным правилам</a>
* <a href="">Вывести таблицу с измененными названиями книг</a>
* <a href="h">Обрезать названия книг, которые длиней 15 символов</a>
* <a href="">Обрезать названия книг, которые длиней 15 символов и фамилии авторов по определенным правилам</a>
#
