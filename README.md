...
1. <a href="https://github.com/kolesnikovvitaliy/SQL_PRACTICS/tree/main/T_SQL">T_SQL расширенные возможности</a>
2. <a href="#">Запросы T-SQL к связанным таблицам</a>
3. <a href="#">Расширенные возможности T-SQL</a>
#
...
3. Клонировать репозиторий себе на локальный компьютер:
   ```bash
   git clone https://github.com/kolesnikovvitaliy/SQL_PRACTICS.git
    ```
4. Перейти в каталог SQL_PRACTICS:
   ```bash
   cd SQL_PRACTICS
    ```
